export const CV_MARKDOWN = `# Hayden Carnegie
**Senior Product Designer**

hayden.a.carnegie@gmail.com | +44 (0) 7903 700 886 | Eastbourne, United Kingdom
[linkedin.com/in/haydencarnegie](https://linkedin.com/in/haydencarnegie)
...
### **Senior Product Designer (Director)** — Leviathan UX
*May 2022 – Present | Remote, United Kingdom*
...
### **Senior Product Designer (Design Lead)** — Automation Squared
...
### **UX Designer** — Catalyst EU
*May 2019 – Oct 2019 | 5 months | Brighton*
...
### **UX Designer** — Barkweb
*Aug 2015 – Jun 2019 | 3 years 11 months | Eastbourne*

- Identified key drop-off points in client journeys using Google Analytics, translating data into targeted design interventions
- Partnered with clients to define design requirements, translating briefs into interactive prototypes using Framer and developing web templates in HTML5/SCSS

---

### Earlier Roles (2009–2015)

- Creative Designer, Freelance (Jan–Aug 2015, Brighton)
- Web Designer, Stealth Media Group (2014, Brighton)
- Web Design & Admin, Hanwood Holdings (2013, Gibraltar)
- Web Design & Admin, Equity Services (2011–2012, Marbella)
- Web Designer, East Sussex Design (2009–2011, Seaford)
...
### Design Practice
Product Design, UX Strategy, Design Leadership, User Research, Stakeholder Management, Interaction Design, Information Architecture, Journey Mapping, Design System Architecture, Prototyping, Wireframing, Design Sprints, Workshop Facilitation, Accessibility, Mentoring, Cross-functional Collaboration, Agile / Scrum, Design Operations
...
Lead designer across a portfolio of high-trust fintech and healthtech products,
...
- Conducted data-driven, research-led design across payment flows, onboarding
  journeys, and trust-critical interactions
...
Short-term embedded designer, delivering research-led UX improvements and
leading design for an internationally deployed learning product.
...
- Identified key drop-off points in client journeys using Google Analytics,
  translating data into targeted design interventions
- Partnered with clients to define design requirements, translating briefs into
  interactive prototypes using Framer and developing web templates in HTML5/SCSS
...
Design Practice:
Product Design, UX Strategy, Design Leadership, User Research,
Stakeholder Management, Interaction Design, Information Architecture,
Journey Mapping, Design System Architecture, Prototyping, Wireframing,
Design Sprints, Workshop Facilitation, Accessibility, Mentoring,
Cross-functional Collaboration, Agile / Scrum, Design Operations

Domain Knowledge:
Open Banking (PSD2), Payment UX, KYC / Onboarding Compliance,
Regulatory UX, Compliance-aware Design, Regulated Financial Products,
Digital Health, Clinical UX, Behavioural Design,
